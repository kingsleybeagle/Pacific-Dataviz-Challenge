...
I used Google Gemini to assist in the development of this project, which was an interesting exercise in managing scope creep. Early iterations of this project included Streamlit apps and Piecewise Linear Regression. At one point I was considering assessing initiatives from the Galapagos Islands to comparable Pacific Locations. I found it very useful to keep coming back to the original brief and used that as a guide to hone my approach into something that is much simpler in execution, and arguably much more accessible in terms of content.
